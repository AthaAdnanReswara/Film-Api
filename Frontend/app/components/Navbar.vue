<script setup>
const { data: category, pending, error } = await useFetch('http://localhost:8000/api/category')
</script>
<template>
    <!-- header -->
    <header class="header">
                ...
                <div class="col-12">
                    <div class="header__content">
                        ...
                        <ul class="header__nav">
                            ...
                            <!-- dropdown -->
                            <li class="header__nav-item" x>
                                <a class="header__nav-link" href="#" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">Category <i class="ti ti-chevron-down"></i></a>

                                <ul class="dropdown-menu header__dropdown-menu">
                                    <li v-if="pending" class="text-center text-danger">
                                        Loading...
                                    </li>
                                    <li v-if="error" class="text-center text-danger">
                                        gagal mengambil data...
                                    </li>
                                    <li v-for="cat in category" :key="cat.id">
                                        <NuxtLink :to="`/category/${cat.slug}`">{{ cat.nama_category }}</NuxtLink>
                                    </li>
                                </ul>
                            </li>
                            <!-- end dropdown -->
